...
public class DBUtils {
	...
	public static List getPaymentDetailsByPurchaseId(Class clazz, int id, String joinTable) throws Exception {
		return getUtils().getPaymentDetailsByPurchaseId(clazz, id, joinTable);
	}
}
